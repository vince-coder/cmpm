export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-brand-900 text-white">
      ...
      <div className="container-cmpm relative py-24 md:py-32">
...
export function Placeholder({ note }: { note: string }) {
  return (
    <div className="container-cmpm py-20">
      <div className="rounded-2xl border border-dashed border-line bg-surface-2 p-10 text-center text-ink-soft">
